...
<p><b>Student Roll Id :</b> <?php echo htmlentities($result->RollId);?></p>
<p><b>Student Class:</b> <?php echo htmlentities($result->ClassName);?></p>(<?php echo htmlentities($result->Section);?>)
<?php }
